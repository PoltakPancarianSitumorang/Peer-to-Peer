            ...
            try {
                ...
                if(msg.type.equals("message")){
                    ...
                    if(msg.content.equals("TRUE")){
                        ...
                        ui.jTextArea1.append("[SERVER > Me] : P2P Successful\n");
                        ui.jTextField3.setEnabled(false); ui.jTextField5.setEnabled(false);
                    }
                    else{
                        ui.jTextArea1.append("[SERVER > Me] : P2P Failed\n");
                    }
                }
                else if(msg.type.equals("test")){
                    ui.jButton1.setEnabled(false);
                    ui.jButton2.setEnabled(true); ui.jButton3.setEnabled(true);
                    ui.jTextField3.setEnabled(true); ui.jTextField5.setEnabled(true);
                  ...
                  //  ui.jButton7.setEnabled(true);
                    ...
                    if(msg.content.equals("TRUE")){
                        ui.jButton2.setEnabled(false); ui.jButton3.setEnabled(false);
                        ui.jButton4.setEnabled(true); //ui.jButton5.setEnabled(true);
                        ui.jTextArea1.append("[SERVER > Me] : Add Successful\n");
                    }
                    else{
                        ui.jTextArea1.append("[SERVER > Me] : Add Failed\n");
                    }
                }
